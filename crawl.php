...
<head>
	...
	<link rel="icon" type="image/x-icon" href="assets/images/favicon/Z.ico">
	<link rel="shortcut icon" type="image/jpg" href="assets/images/favicon/Z 32 32.jpg">
	<link rel="apple-touch-icon" href="assets/images/favicon/apple-touch-icon.png">
	<link rel="android-chrome-icon" type="image/jpg" href="assets/images/favicon/Z 512 512.jpg">

	<meta charset="utf-8">
	<meta name="description" content="Search the web for sites and images.">
	<meta name="keywords" content="Search engine, zeeva, websites">
	<meta name="author" content="zeeva">
